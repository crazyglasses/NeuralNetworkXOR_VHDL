#include "isim/work/syn_0_update/behavioral.h"
...
#include "isim/work/floatpt/floatpt.h"
#include "isim/work/mypackage/mypackage.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_syn_0_update_behavioral("syn_0_update");
...
main(int argc, char **argv) {
  ...
  try {
    ...
    WorkFloatpt=new Work_floatpt("Floatpt");
    WorkMypackage=new Work_mypackage("Mypackage");
    HSimConfigDecl *cfg;
 _top_i = new _top();
